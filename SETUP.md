...
| User / Password      | N/A — uses your Windows login              |
| ODBC Driver          | `ODBC Driver 17 for SQL Server`            |

### How Django connects

In `backend/core/settings.py`, the `DATABASES` block is already configured:
...
> **Note:** If your SQL Server instance name is different (e.g., `.\SQLEXPRESS`), change the `"HOST"` value in `settings.py` to match.
...
5. Database name: `jrmsu_library`
6. Click **OK**.

### Option B: Via the helper script
...
```
pip install django djangorestframework django-cors-headers mssql-django django-filter pyodbc
```
